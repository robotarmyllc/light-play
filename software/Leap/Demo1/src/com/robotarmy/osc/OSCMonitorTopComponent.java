...
public final class OSCMonitorTopComponent extends TopComponent {
    ...
    private static final long serialVersionUID = 178657658L;
    static final Logger log = Logger.getLogger("OSCTopComponent");
    ...
    private void addOSCListener() throws SocketException {
        ...
        OSCListener listener = (Date time, OSCMessage message) -> {
