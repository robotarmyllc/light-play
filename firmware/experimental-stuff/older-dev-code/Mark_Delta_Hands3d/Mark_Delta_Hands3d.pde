...
//      byte x = (byte)(((p.x + 400)/10)+80);
//      byte y = (byte)(((p.y + 400)/10)+80);
//      byte z = (byte)((p.z-600)/8);
    //println("oX: " + p.x + "   oY: " + p.y + "  oZ: " + p.z );
...
//      byte x = (byte)((p.x + 240)/2);
//      byte y = (byte)((-p.y + 240)/2);
//      byte z = (byte)((p.z + 240)/2);

      PVector pa = getAveragedPoint();
      
//      int x = (byte)((pa.x + LIMIT)/DIV);
//      int y = (byte)((-pa.y + LIMIT)/DIV);
//      int z = (byte)((pa.z + LIMIT)/DIV);
