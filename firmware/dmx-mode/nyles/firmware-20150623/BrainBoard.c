...
#define MAX_SERVO 140           // Was 140...  max is min and vice versa
                                //  so why oh why are we losing range on the output?  Hmm.
#define FLAT_SERVO 120

    // Bit definitions for LEDs
#define LED_RED   0x08
#define LED_GREEN 0x20
#define LED_BLUE  0x40

#define DEF_RED 200             // Default red level
#define DEF_GRN 255             // Default green level
#define DEF_BLU 10              // Default blue level
...
#define SLEW_RANGE 4.0  // Range that the 0-255 input gets normalized to, actually +-2.0
/*
...
*/
#define SLEW_TIME 0.5   // Time to slew the servo completely, guessing half a second
#define ACC_TIME 7      // Time to go from standing start to full speed, in ACC_TICKs
...
int main(void)
{
    ...
    dmx_chan |= (~PIND & 0x10) << 2;     // PD4 is bit 6   BUG FIX 20150708
